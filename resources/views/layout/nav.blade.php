            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="{{!is_null(Auth::guard('admin')->user()) && isset(Auth::guard('admin')->user()->image) ? asset('uploads/users/' . Auth::guard('admin')->user()->image) : asset('assets/img/avatars/1.png')  }}" alt class="w-px-40 rounded-circle" />
                    </div>
                </a>
